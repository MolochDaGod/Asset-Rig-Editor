      ...
      >
        {TABS.map((tab) => (
          <button
            ...
            className="flex-1 min-w-[2.6rem] flex flex-col items-center gap-0.5 py-2.5 text-xs transition-all"
            style={{
          ...
          >
            ...
            <span className="font-semibold text-[8px] tracking-widest uppercase">{tab.label}</span>
          </button>
        ))}
      </div>
